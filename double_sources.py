...
yi11 =  xi1[0]-af1*(mm.Da2(zl,zs1)/mm.Da(zs1))*(mm.Da(zs0)/mm.Da2(zl,zs0))
yi12 =  xi2[0]-af2*(mm.Da2(zl,zs1)/mm.Da(zs1))*(mm.Da(zs0)/mm.Da2(zl,zs0))

yi21 =  xi1[0]-af1*(mm.Da2(zl,zs2)/mm.Da(zs2))*(mm.Da(zs0)/mm.Da2(zl,zs0))
yi22 =  xi2[0]-af2*(mm.Da2(zl,zs2)/mm.Da(zs2))*(mm.Da(zs0)/mm.Da2(zl,zs0))
...
pyfits.writeto(filename,image1+image2,clobber=True)
##--------------------------lens images contour------------------------
